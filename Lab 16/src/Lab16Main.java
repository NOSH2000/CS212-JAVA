public class Lab16Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Here is myList1: " + myList1);
        System.out.println("Found bat in myList1= " + myList1.find("bat"));

        myList1.addBeforeGiven("bat", "fly");
        System.out.println("Before bat = " + myList1);

        myList1.addAfterGiven("bat", "fly");
        System.out.println("After bat = " + myList1);
        System.out.println();

        System.out.println("Here is myList2: " + myList2);
        System.out.println("myList1 equal myList2: " + myList1.equals(myList2));

        // fill list 3 and list 4 using prepend and print it
        for (int i = 0; i < dataSource.length; i++) {
        ...
        // fill list 5 and list 6 using append and prepend to create
        // a palindrome
        for (int i = 0; i < dataSource.length; i++) {
