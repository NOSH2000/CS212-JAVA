...
public class Lab11 {
    ...
    private static void readAndDisplayMatrix(JFrame myFrame, JTextArea myText, JLabel myLabel) {
        /*
         * Fill in this method. It should fill the text area with the matrix (as
         * you did to a message dialog in a previous lab, calculate the sum
         * (code from a previous lab) and set the text of the label to show the
         * sum. Re-display the JFrame using the setVisible(true) method. The
